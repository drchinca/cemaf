...
4. [**Architecture Atlas**](architecture/cemaf-architecture.html) — a visual, multi-view tour (open in a browser); ground-truth companion to [deep-architecture.md](architecture/deep-architecture.md)
