...
> **For AI coding systems (Cursor, Gemini, Claude):** Refer directly to the [AI Integration & Development Guide](AI_DEVELOPMENT_GUIDE.md) for dense code recipes, Python 3.12+ standards, and direct Do/Violation matrices.
