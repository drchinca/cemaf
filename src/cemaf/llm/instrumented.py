...
class InstrumentedLLMClient:
    ...
    async def complete(
        ...
        """Complete and record the LLM call."""
    ...
    async def stream(
        ...
        """Stream and record the LLM call after completion."""
        start_ns = time.perf_counter_ns()
        accumulated = ""
        prompt_tokens = 0
        completion_tokens = 0
        ...
        async for chunk in aiter:
            ...
            completion_tokens = int(chunk.completion_tokens) if chunk.completion_tokens else completion_tokens
            yield chunk
