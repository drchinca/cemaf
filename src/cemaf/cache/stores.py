...
class InMemoryCache:
    ...
    async def set(self, key: str, value: Any, ttl_seconds: int | None = None, metadata: JSON | None = None) -> None:
    ...
    async def stats(self) -> CacheStats:
        ...
        return CacheStats(hits=self._hits, misses=self._misses, size=len(self._entries), evictions=self._evictions)
