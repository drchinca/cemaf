...
from cemaf.core.types import JSON, NodeID, AgentID, SkillID, ToolID
from cemaf.core.enums import NodeType
from cemaf.core.constants import MAX_DAG_DEPTH, CYCLE_DETECTION_LIMIT
...
class Condition:
    ...
    def evaluate(self, context: Context) -> bool: # Updated signature
        ...
        if op == ConditionOperator.GREATER_THAN:
            return current_val is not None and self.value is not None and current_val > self.value # Added None checks
