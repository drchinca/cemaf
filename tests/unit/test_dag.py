...
from cemaf.orchestration.dag import DAG, Node, Edge, EdgeCondition, Condition, ConditionOperator
...
class TestCondition:
    ...
    @pytest.mark.parametrize("field, op, value, context_dict, expected", [ # Changed 'context' to 'context_dict'
        # EQUALS
