...
class TestCompiledContext:
    ...
    def test_within_budget_respects_available(self):
        ...
        sources = (
            ContextSource(type="artifact", key="a", content="x" * 900, token_count=900),
        )
    ...
    def test_within_budget_passes(self):
        ...
        budget = TokenBudget(max_tokens=1000, reserved_for_output=200)
        sources = (
            ContextSource(type="artifact", key="a", content="x", token_count=100),
        )
...
class TestPriorityContextCompiler:
    ...
    @pytest.mark.asyncio
    async def test_compile_respects_budget(self):
    ...
    @pytest.mark.asyncio
    async def test_compile_respects_priority(self):
